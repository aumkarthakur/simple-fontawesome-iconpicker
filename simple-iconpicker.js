...
function iconpickerbox() {
    ...
    for (var i = 0; i < fontawesomeiconArray.length; i++) {
        $(".howl-iconpicker .iconsholder").append('<p class="geticonval"><i class="fa ' + fontawesomeiconArray[i] + '"></i>'+fontawesomeiconArray[i]+'</p>');
    }
    ...
    $.fn.iconpicker = function(selector) {
        ...
        $(this).focusin(function() {
            ...
            $(".howl-iconpicker .geticonval").on('click', function() {
                ...
                if ( $(selector).attr('class') == whichInput ) {
                    $(selector).val(getIconId);
                }
            });
