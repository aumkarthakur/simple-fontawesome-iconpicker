...
function iconpickerbox(classid) {
    ...
    // When user will click on any icon this code will get icon class and make it input box value
    $(dotnewclassids + " .geticonval").click(function() {
        var geticonid = $(this).text();
        $(classid).val(geticonid);
        $(dotnewclassids + " .geticonval").removeClass('selectedicon');
...
(function($) {
    ...
    $.fn.iconpicker = function(selector) {
        iconpickerbox(selector); // calling iconpicker function and passing inputbox class as argument, 'this' is Object
        var newclassids = "no" + selector.replace(/#|\./g,'');
        var dotnewclassids = "." + newclassids;

        // if user focus on inputbox SHOW iconpicker box
        $(this).focusin(function() {
            $(dotnewclassids).css('display', 'block');
        });

        // if user focusout of input box and alse iconpicker box that hide iconpicker box
        $(this).on('focusout', function() {
            if (!$('.iconpicker').is(':focus')) {
